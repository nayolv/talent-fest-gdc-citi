  ...
  return (
    <div className="container-home ">
      <section className="offers-container">
        <h2 id="tooltip" data-info="Ofertas Citibanamex">
          Ofertas Citibanamex
        </h2>
          ...
          <section className="card-home">
            ...
            <section className="text-promotion-container">
              <p
                ...
                id="tooltip"
                data-info="Bobby Brown"
              >
                Bobby Brown
              </p>
              <p id="tooltip" data-info="15% de descuento">
                15% de descuento
              </p>
            </section>
          </section>
          ...
          <section className="card-home">
            ...
            <section className="text-promotion-container">
              <p
                className="title-card-home"
                id="tooltip"
                data-info="Pase Anual Citibanamex"
              >
                Pase Anual Citibanamex
              </p>
              <p id="tooltip" data-info="Inscríbete y obtén 6 MSI">
      ...
      <section className="container-acconts">
        <p id="tooltip" data-info="Cuentas de efectivo">
          Cuentas de efectivo
        </p>
            ...
            <section className="card-home-container">
              ...
              <section>
                ...
                <p
                  ...
                  id="tooltip"
                  data-info={`**${item.displayAccountNumber.slice(-3)}`}
                >
...
<<<<<<< HEAD
            <section className="avalaible-container">
              <p id="tooltip" data-info="Disponible:">
                Disponible:
              </p>
              <section>
                <p className="balance">{item.maximumAmount}</p>
                <p id="tooltip" data-info={`${item.maximumAmount}MXN`}>
                  MXN
                </p>
              </section>
            </section>
            ...
            <section className="avalaible-container">
              ...
              <section>
                <p
                  className="balance"
                  id="tooltip"
                  data-info={`**${item.balance}`}
                >
                  {item.balance}
                </p>
                <p id="tooltip" data-info="MXN">
                  MXN
                </p>
              </section>
            </section>
=======
        ...
        <section className="avalaible-container">
          ...
          <section>
            <p className="balance" id="tooltip" data-info={`${item.balance}`}>{item.balance}</p> 
            <p id="tooltip" data-info="MXN">MXN</p>
>>>>>>> 9a071f85e089857d18057a023c619232eef8cd49
          </section>
        ))}
      </section>
    </div>
